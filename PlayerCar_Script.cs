...
public class PlayerCar_Script : MonoBehaviour {
	...
	void  FixedUpdate (){
		...
		FrontLeftWheel.steerAngle = 2 * Input.GetAxis("Horizontal");
		FrontRightWheel.steerAngle = 2 * Input.GetAxis("Horizontal");
    ...
    public void ShowReachingLastPointMessageOnDash()
    {
        dashMessages.text = "About to reach \n last point!";
        StartCoroutine(ClearDashMessage());
    }

    public void ShowMessageOnReachingAccidentSite()
    {
        dashMessages.text = "About to reach \n accident site!";
        // Deactivating AI
